...
public class Aplicacion {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 2:
				...
				aniosExpBibliotecario = leerEnteroVentana("\"Ingrese los años de experiencia ddel bibliotecario\"");
				...
				if(resultado) {
					mensaje = biblioteca.crearBibliotecario(nombreBibliotecario,identificacionBibliotecario,direccionBibliotecario,telefonoBibliotecario,aniosExpBibliotecario);
					imprimir(mensaje);
				}else {
					imprimirError(mensaje);
				}
			...
			case 7:
				...
				case 10:
					...
					String datos;
					if(resultado) {
						datos = biblioteca.consultarBibliotecario();
						imprimir("los datos son " +datos+ );
					}
			...
			case 11:
				...
				case 1:
					...
					precioPrestamo = leerEnteroVentana("\"Ingrese el precio del prestamo\"");
				...
				case 4:
					...
					valorPrestamo=leerEnteroVentana("\"Ingrese el valor del prestamo\"");
					subTotal=leerEnteroVentana("\"Ingrese el sub total del prestamo\"");
					
					resultado= validarInformacionPrestamo(titulo, codigo, codigoPrestamo);
					if(fechaPrestamo<31 && fechaDevolucion<31) {
					if(resultado) {
						mensaje = biblioteca.crearPrestamo(fechaPrestamo, titulo,  codigo, codigoPrestamo,  fechaDevolucion, valorPrestamo, estudiante, bibliotecario);
						imprimir(mensaje);
					}}else {
						imprimirError(mensaje);
					}
	...
	private static int mostrarMenu() {
		...
		String menu = "Seleccione la opcion que desea realizar :\n"
				...
				+ "10 consultar informacion de bibliotecario usando isbn"
				+ "11 Opciones Libros y Prestamos\n\n"
