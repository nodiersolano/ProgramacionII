...
public class Aplicacion {
	...
	public static void main(String[] args) {
		...
		String    añosDeServicioBibliotecario;
		...
		do {
			...
			case 2:
				...
				añosDeServicioBibliotecario = leerStringVentana("\"Ingrese los años de servicio del bibliotecario\"");
				...
				if (resultado) {
					mensaje = biblioteca.crearBibliotecario(nombreBibliotecario, identificacionBibliotecario,
							direccionBibliotecario, telefonoBibliotecario, añosDeServicioBibliotecario);
					imprimir(mensaje);
				} else {
					imprimirError(mensaje);
				}
