...
public class Biblioteca {
	...
	public String crearEstudiante(String nombre, String identificacion, String direccion, String telefono) {
		String mensaje = "No es posible crear mÃ¡s estudiantes";
		if (estudiante1 == null) {
	 ...
	 * @return
	 */
	public String crearBibliotecario(String nombre, String identificacion, String direccion, String telefono,String añosServicio) {
		String mensaje = "No es posible crear mas bibliotecarios";
		if (bibliotecario1 == null) {
			bibliotecario1 = new Bibliotecario(nombre, identificacion, direccion, telefono, añosServicio);
			mensaje = "Bibliotecario creado con exito";
		} else {
			if (bibliotecario2 == null) {
				bibliotecario2 = new Bibliotecario(nombre, identificacion, direccion, telefono, añosServicio);
				mensaje = "Bibliotecario creado con exito";
			}
		}
